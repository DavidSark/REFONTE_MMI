...
<template>
    ...
    <div class="container__index-heroT">
      ...
      <div class="container__index-heroC">
        <heroC-hover  title="le département" tagline="un espace rempli de créativité" TopImage="/images/formation-heroM-1.webp" BottomImage="/images/formation-heroM-2.webp" Button1="Candidater" Button2="Formation" Button1Url="/candidater" Button2Url="/formation"> 
        </heroC-hover>
      </div> 
